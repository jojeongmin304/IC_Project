...
static constexpr auto qt_meta_stringdata_ZN13SpeedProviderE = QtMocHelpers::stringData(
    "SpeedProvider",
    "speedChanged",
    "",
    "speed"
...
Q_CONSTINIT static const uint qt_meta_data_ZN13SpeedProviderE[] = {
...
Q_CONSTINIT const QMetaObject SpeedProvider::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13SpeedProviderE.offsetsAndSizes,
    qt_meta_data_ZN13SpeedProviderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13SpeedProviderE_t,
        // property 'speed'
...
void SpeedProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SpeedProvider::*)();
            if (_q_method_type _q_method = &SpeedProvider::speedChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SpeedProvider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13SpeedProviderE.stringdata0))
